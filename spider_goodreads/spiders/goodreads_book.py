...
# https://www.goodreads.com/author/list/93621.Ellen_Jackson   作者书籍清单
    #开始种子URL
    start_urls = ['https://www.goodreads.com/book/show/34605845']
    ...
    def parse(self, response):
            ...
            description=response.xpath("//div[@id='description']/span/text()|//div[@id='description']//p//text()").extract()[-1].strip() if response.xpath("//div[@id='description']/span/text()|//div[@id='description']//p//text()").extract() else "None"
