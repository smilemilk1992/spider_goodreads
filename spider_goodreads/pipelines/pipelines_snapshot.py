...
class SpiderGoodreadsPipeline(object):
    cc = '''INSERT IGNORE into p_news_snapshot(goodreadsId,relationId,goodreadsUrl,title,goodreadsAmazonUrl,amazonUrl,goodreadsAlibrisUrl,walmarteBooksUrl,goodreadsBarnesNoble,barnesNoble)value(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'''
