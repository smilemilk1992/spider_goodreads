...
class SpiderGoodreadsPipeline(object):
    cc = '''INSERT IGNORE into p_news_snapshot2(goodreadsId,relationId,goodreadsUrl,title,goodreadsAmazonUrl,amazonUrl,goodreadsAlibrisUrl,alibrisUrl,goodreadsWalmarteBooksUrl,walmarteBooksUrl,goodreadsBarnesNoble,barnesNoble)value(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'''
